...
// we need to store the state of the form in the state of the react component
   ...
   <div className='row row-content'> 
     ...
     <div className='col-12 col-sm-4 offset-sm-1'>
       ...
       <address>
           ...
           Clear Water Bay, Kowlon<br/>
           Hong Kong<hr/>
           <i className='fa fa-phone fa-lg'></i>: +852 1324 5678<br/>
           <i className='fa fa-fax fa-lg'></i>: +852 8765 4321<br/>
           <i className='fa fa-envelope fa-lg'></i>: <a href='mailto:confusion@food.net'>confusion@food.net</a><br/>
       </address>
     </div>
     ...
     <div className='col-12 col-sm-11 offset-sm-1'>
       <div className='btn-group' role='group'>
         ...
         <a role='button' className='btn btn-primary' href='mailto:confusion@food.net'><i className='fa fa-envelope-o'></i>Email</a>
       </div>
     </div>
